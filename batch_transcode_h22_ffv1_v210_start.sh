...
#transcode_path1="${QNAP10_H22}hdd/prores/SASE/source"
#transcode_path2="${QNAP10_H22}lto/prores/NEFA/source"
#transcode_path3="${QNAP10_H22}lto/prores/YFA/source"
transcode_path4="${QNAP10_H22}lto/v210/NWFA/source"
...
echo " == Start batch_transcode_h22_ffv1_v210 in transcode paths == " >> "${log_path}batch_transcode_h22_ffv1_v210.log"
...
grep '/mnt/' "${dump_to}batch_transcode_h22_ffv1_v210_dump_text.txt" | sort -u | parallel --jobs 15 "sudo python3 $python_script {}"
