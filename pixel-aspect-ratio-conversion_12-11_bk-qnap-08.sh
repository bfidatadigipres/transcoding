...
# 172.18.7.38:/ifs/data/Video/Video\040Operations /mnt/qnap/video_operations     nfs     defaults 0 0
# 
# Example incorrect aspect ratio MOV files are currently in:
# \\isilon\Video\Video Operations\Test Captures for Suppliers\MX1\1inch\incorrect aspect ratio
#
# Entry in /etc/crontab
# */1 * * * * root /root/par-conversion-code/pixel-aspect-ratio-conversion_12-11.sh > /var/log/pixel-aspect-ratio-conversion/pixel-aspect-ratio-conversion_12-11_error.log 2>&1
#
...
mmeLocation='${MMELOCATION}'

# Where the Isilon PAR folder is mounted on this system (no trailing slash)
mountPoint='${QNAP_08}'
#mountPoint='/mnt/isilon/video_operations/PAR-Corrections'
...
sysLogLocation="$SYS_LOG_LOCATION"
